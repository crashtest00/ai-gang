...
- /django-admin/ — django.contrib.admin, the human-facing admin UI (the
  "capability that comes with the framework" Django provides for free).
- everything else, INCLUDING /admin/work-items... — workitems.urls, the
  direct query/admin-write HTTP interface, preserving the
